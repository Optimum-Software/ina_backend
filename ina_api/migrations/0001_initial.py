# Generated by Django 2.0.5 on 2019-01-28 10:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.IntegerField(choices=[(1, 'Chat'), (0, 'Project')])),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('chat', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ina_api.Chat')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ina_api.Project'),
        ),
        migrations.AddField(
            model_name='notification',
            name='user',
