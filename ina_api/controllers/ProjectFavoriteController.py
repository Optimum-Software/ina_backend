...
def getProjectFavoriteById(request, id):
    try:
        ...
        return JsonResponse({"bool": True, "msg": "ProjectFavorite bestaat", "projectLiked": projectFavoriteJson, "user": userObject, "project": projectObject}, safe=True)
    except ObjectDoesNotExist:
        return JsonResponse({"bool": False, "msg": "ProjectFavorite bestaat niet"}, safe=True)